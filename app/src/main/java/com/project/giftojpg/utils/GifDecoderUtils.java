package com.project.giftojpg.utils;
...
/**
 * 包名:      com.project.giftojpg.utils
 * 文件名:    GifDecoderUtils
 * 创建者:    hello
 * 创建时间:  2017/2/24 10:55
 * 描述:      TODO
 */
public class GifDecoderUtils {
    private static final String          TAG  = GifDecoderUtils.class.getSimpleName();
    private final        GifDecoderUtils self = this;
